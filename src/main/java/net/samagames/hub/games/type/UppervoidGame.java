...
public class UppervoidGame extends AbstractGame
{
    ...
    public ShopCategory getShopConfiguration()
    {
        ...
        ShopImprovableItem grapnelItem = new ShopImprovableItem(this, "grapin", "Grapin", new ItemStack(Material.LEASH, 1), 32, new String[] {
    ...
    {
        return new Location(Hub.getInstance().getHubWorld(), -156.5D, 79.0D, -3.5D, 90.0F, 0.0F);
    }
