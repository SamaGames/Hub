...
public class QuakeGame extends AbstractGame
{
    ...
    public ShopCategory getShopConfiguration()
    {
        ...
        ShopDependsItem woodenHoe = new ShopDependsItem(this, "hoe", "woodhoe", "SlowGun", new ItemStack(Material.WOOD_HOE),new String[]{
        ...
        ShopDependsItem goldHoe = new ShopDependsItem(this, "hoe", "goldenhoe", ChatColor.GOLD + "Golden Gun", new ItemStack(Material.GOLD_HOE, 1),new String[]{
                ChatColor.DARK_GRAY + "Recharge en " + ChatColor.GOLD + "1.5" + ChatColor.DARK_GRAY + " secondes."
        }, 5000, ironHoe);
        hoes.addContent(goldHoe);

        ShopDependsItem diamondHoe = new ShopDependsItem(this, "hoe", "dimaondhoe", ChatColor.BLUE + "PortalGun", new ItemStack(Material.DIAMOND_HOE, 1),new String[]{
                ChatColor.DARK_GRAY + "Recharge en " + ChatColor.GOLD + "1.4" + ChatColor.DARK_GRAY + " secondes."
        }, 20000, goldHoe);
        hoes.addContent(diamondHoe);

        ShopDependsItem amazingHoe = new ShopDependsItem(this, "hoe", "amazinghoe", ChatColor.AQUA + "Amazing" + ChatColor.BLUE + " PortalGun", GlowEffect.addGlow(new ItemStack(Material.DIAMOND_HOE, 1)),new String[]{
       ...
       hoes.addContent(blasterHoe);
        ...
        ShopImprovableItem grenadeItem = new ShopImprovableItem(this, "grenade", "Grenades", new ItemStack(Material.CLAY_BALL, 1), new String[] {
