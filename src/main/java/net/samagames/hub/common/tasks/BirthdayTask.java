 ...
 */
public class BirthdayTask extends AbstractTask
{
    ...
    BirthdayTask(Hub hub)
    {
        ...
        this.infos.add(new BirthdayInfo(UUID.fromString("f79c6c7f-fe45-4502-8f2a-de9f92dcaade"), 8,     4,   Particle.DRIP_WATER,        Color.BLUE));                                                 //TB1144
        ...
        //TODO Pizzarty ArkaCyr MinRin_25
