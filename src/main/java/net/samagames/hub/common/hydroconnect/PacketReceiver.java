...
public class PacketReceiver {
    ...
    {
        callbacks.stream().filter(callBack -> callBack.getPacketClass().equals(packet.getClass())).forEach(callBack -> Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> callBack.call(packet)));
    }
}
