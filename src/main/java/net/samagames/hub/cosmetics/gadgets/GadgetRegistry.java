...
class GadgetRegistry extends AbstractCosmeticRegistry<GadgetCosmetic>
{
    ...
    {
        GadgetCosmetic expressBotaniaGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "Apprenti botaniste", new ItemStack(Material.RED_ROSE, 1), 700, CosmeticRarity.RARE, CosmeticAccessibility.ALL, new String[] {
                "Les fleurs, ce n'est pas que",
                "pour les filles.",
                "Profitez-en :)"
        }, ExpressBotaniaDisplayer.class, 60);

        GadgetCosmetic holyCreeperGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "Mon ami le Creeper", new ItemStack(Material.SULPHUR, 1), 500, CosmeticRarity.COMMON, CosmeticAccessibility.ALL, new String[] {
        ...
        GadgetCosmetic magicCakeGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "Gâteau fantôme", new ItemStack(Material.CAKE, 1), 500, CosmeticRarity.COMMON, CosmeticAccessibility.ALL, new String[] {
        ...
        GadgetCosmetic moutMout2000Gadget = new GadgetCosmetic(this.hub, TODO_SHOP, "MoutMout 2000", new ItemStack(Material.WOOL, 1), 900, CosmeticRarity.EPIC, CosmeticAccessibility.ALL, new String[] {
                "Faites attention à lui, il ne",
                "sait absolument pas s'arrêter."
        }, MoutMout2000Displayer.class, 60);

        GadgetCosmetic trampoSlimeGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "TrampoSlime", new ItemStack(Material.SLIME_BLOCK, 1), 900, CosmeticRarity.EPIC, CosmeticAccessibility.ALL, new String[] {
                "Qu'est-ce que c'est distrayant",
                "de faire des bonds sur des",
                "restes de slimes compactés."
        }, TrampoSlimeDisplayer.class, 60);

        GadgetCosmetic discoBombGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "Bombe Disco", new ItemStack(Material.STAINED_GLASS, 1, DyeColor.PURPLE.getData()), 700, CosmeticRarity.RARE, CosmeticAccessibility.ALL, new String[] {
                "Exprimez vos talents de danseur sous",
                "les feux de votre Bombe Disco !"
        }, DiscoBombDisplayer.class, 60);

        GadgetCosmetic enderSwapGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "EnderSwap", new ItemStack(Material.ENDER_PEARL, 1), 500, CosmeticRarity.COMMON, CosmeticAccessibility.VIP, new String[] {
        ...
        GadgetCosmetic animalChestGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "Coffre super secret", new ItemStack(Material.MONSTER_EGG, 1), 500, CosmeticRarity.COMMON, CosmeticAccessibility.VIPPLUS, new String[] {
        ...
        GadgetCosmetic perchedCatGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "Chat perché !", MojangShitUtils.getMonsterEgg(EntityType.OCELOT), 1100, CosmeticRarity.LEGENDARY, CosmeticAccessibility.VIPPLUS, new String[] {
        ...
        GadgetCosmetic nukeGadget = new GadgetCosmetic(this.hub, TODO_SHOP, "Bombe atomique", new ItemStack(Material.TNT, 1), 42000, CosmeticRarity.ADMIN, CosmeticAccessibility.ADMIN, new String[] {
