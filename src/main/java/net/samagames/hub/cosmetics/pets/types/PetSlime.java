...
import net.samagames.hub.cosmetics.pets.nms.CosmeticSlime;
...
public class PetSlime extends PetCosmetic<Slime>
{
    public PetSlime(String databaseName, String displayName, ItemStack icon, String[] description)
    {
        super(databaseName, displayName, icon, description, CosmeticSlime.class);
    }

    @Override
    public void onUse(Player player)
    {
        final PetSlime instance = this;
        ...
        AbstractGui gui = new AbstractGui()
        {
            ...
            public void display(Player player)
            {
                ...
                while (i < 3)
                {
                    this.setSlotData(this.inventory, "Taille " + (i + 1), new ItemStack(Material.SLIME_BALL, i + 1), i, null, "" + i);
                    i++;
                }
    ...
    @Override
    public void applySettings(Slime spawned, String settings)
    {
