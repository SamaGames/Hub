...
public class NBSDecoder {
    ...
    public static Song parse(String decodeFileName) {
        return parse(new File(Bukkit.getWorlds().get(0).getWorldFolder().getParent(), "plugins" + File.separator + "Hub" + File.separator + "nbs" + File.separator + decodeFileName + ".nbs"));
    }
